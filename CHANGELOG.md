...
- `projects/n8n-workflows/test_day70_capstone.py` — 14 deterministic tests.
- `projects/n8n-workflows/day70_minimal_acceptance_workflow.json` — a Secret-free importable Workflow source (`Day70 - FastAPI Durable Acceptance Gate`; Credential Store reference only; NOT a captured post-run export).
