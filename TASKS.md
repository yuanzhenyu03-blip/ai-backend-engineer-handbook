...
Target lesson:
Day82 is released and Phase 7B is in progress at classroom scope. Day83 is next.

(Semantics, shared with PROJECT_STATUS.md: "Current Lesson" = the lesson currently being worked on / next up
(Day83); Day82 is finished and most recently released; Day59–70 are complete. Phase 6 (Day67–70) is COMPLETE.
