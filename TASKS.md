...
Target lesson:
Day78 is released and Phase 7A is complete at classroom scope. Day79 is not created yet.

(Semantics, shared with PROJECT_STATUS.md: "Current Lesson" = the lesson currently being worked on / next up
(Day79); Day78 is finished and most recently released; Day59–70 are complete. Phase 6 (Day67–70) is COMPLETE.
...
- [ ] Day79 prep (Phase 7B): build a framework-agnostic Agent Loop above the stable Day78 Runtime; do not reimplement Provider, Prompt, validation, Admission, reconciliation, completion or cost boundaries.
