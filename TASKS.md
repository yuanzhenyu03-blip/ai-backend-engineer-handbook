...
Target lesson:
Day78 is not created yet — see CURRICULUM.md and ROADMAP.md. Day77 is released.

(Semantics, shared with PROJECT_STATUS.md: "Current Lesson" = the lesson currently being worked on / next up
(Day78); Day77 is finished and most recently released; Day59–70 are complete. Phase 6 (Day67–70) is COMPLETE.
...
- [ ] Day78 prep (Phase 7A): integrate the LLM Application Runtime capstone, checkpoint and English interview. Reuse Day71–Day77 evidence without overstating it; do not create Day79 content.
