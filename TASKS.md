...
Target lesson:
Day75 is not created yet — see CURRICULUM.md and ROADMAP.md. Day74 is released.
...
- [ ] Day75 prep (Phase 7A): add Streaming Responses, Caching and Batching without weakening Day74's complete-object validation, tool/version identity, authorization, idempotency, outcome verification or guarded-completion boundaries. Continue the same `projects/ai-agent/` Artifact; do not pre-implement Day76–Day78.
