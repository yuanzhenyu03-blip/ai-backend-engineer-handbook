...
- [x] Complete Day70 n8n + FastAPI + AI Tool Integration Capstone and Interview (Phase 6 close) — lesson (16-section v2, classroom-loop Concepts + exercises + full English Interview; preserved the real short student answers/corrections and the Tech-Lead-taught final synthesis), the capstone artifacts under `projects/n8n-workflows/` (DAY70_CAPSTONE.md + day70_capstone.py + test_day70_capstone.py (14 tests) + Secret-free day70_minimal_acceptance_workflow.json), FastAPI/n8n interview + cheat-sheet appends, and CURRICULUM/ROADMAP/PROJECT_STATUS/CHANGELOG updates (Day70 Completed; Phase 6 COMPLETE; Day71 Planned Phase 7A phase-transition). Mixed evidence tiers: bounded acceptance slice INTEGRATION_RUNTIME (in class), decision model EXECUTED_LOCAL_RUNTIME (14 passed), rest CONCEPTUAL_STATIC / NOT RUN; no post-run n8n export captured; no secrets committed.
