...
(Semantics, shared with PROJECT_STATUS.md: "Current Lesson" = the lesson currently being worked on / next up (Day71);
Day70 is finished and most recently released; Day59–69 are complete. Phase 6 (Day67–70) is COMPLETE. The Phase 5 Production Integration Gate (Day59–61) is COMPLETE.)
...
- [ ] Day71 prep (Phase 7A): begin LLM Application Engineering on the Day53–Day61 Provider/resilience/observability/runtime foundations — architecture, tokens/context/sampling, a replaceable Provider Adapter, prompt contracts/versioning, structured output/function calling. This is a PHASE TRANSITION; n8n is not a prerequisite.
...
- [ ] Day70 prep: assemble the Phase 6 capstone that DIRECTLY integrates Day69 approval + classified retry/error + Secrets + audit with the real FastAPI backend and permissioned browser/AI tool, attempting real cumulative integration evidence.
- [ ] Day70 prep: define the phase-level English interview coverage across Day67–Day69 (boundary, long-job observation/delivery, approval/recovery/audit hardening).
