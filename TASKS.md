...
Target lesson:
Day77 is not created yet — see CURRICULUM.md and ROADMAP.md. Day76 is released.

(Semantics, shared with PROJECT_STATUS.md: "Current Lesson" = the lesson currently being worked on / next up
(Day77); Day76 is finished and most recently released; Day59–70 are complete. Phase 6 (Day67–70) is COMPLETE.
...
- [ ] Day77 prep (Phase 7A): add Fake Provider, Contract Tests and LLM Regression Tests that deterministically pin Day72–Day76 contracts, routing/fallback, latency/cost and unknown-outcome behavior. Continue the same `projects/ai-agent/` Artifact; do not pre-implement Day78.
