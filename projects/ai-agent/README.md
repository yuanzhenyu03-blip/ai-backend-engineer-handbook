...
├── tests/
│   └── test_provider_adapters.py # Day72: 28 deterministic EXECUTED_LOCAL_RUNTIME tests
...
CONCEPTUAL + STATIC + EXECUTED_LOCAL_RUNTIME — `python3 -m unittest discover -s tests -v` → 28 deterministic
