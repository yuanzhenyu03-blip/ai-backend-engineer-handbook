...
fake-session backfill control flow -> 37 passed; Python 3.10.12, Alembic 1.13.1, SQLAlchemy 2.0.29, pytest 7.4.3;
...
│   ├── test_day48_alembic.py                           # Day48: static Alembic + fake-session backfill tests (executed: 37 passed)
