...
Direct prerequisites: Day71 (provider-independent runtime), Day53 (ProviderRequest -> ProviderOutcome seam), Day61 (real-HTTP Adapter foundation). Day72 makes the replaceable Adapter executable (28 in-process tests, EXECUTED_LOCAL_RUNTIME; no real Provider).
