...
- Day58 design/runbook + runnable deterministic in-process observability model (standard-library control flow reusing Day57 taxonomy + Day56 vocabulary) + tests (executed: 37 passed; full api suite 502) and project README increment
