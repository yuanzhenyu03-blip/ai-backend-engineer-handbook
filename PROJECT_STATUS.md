...
- Day49 design/runbook + runnable provider-neutral fake-adapter model + tests (executed: 35 passed; hardened after Codex review round 1) and project README increment
