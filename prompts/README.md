...
Reusable working instructions for AI coding assistants live here.
...
security requirements, quality checks, and the final report format.

## Other prompts

- `codex.md`, `interview.md`, `project.md`, `review.md` — earlier task-specific instructions.
